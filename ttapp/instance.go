...
func New(opts *Options) (*Instance, error) {
	...
	if opts.Request.BaseUri == "" {
		opts.Request.BaseUri = "https://developer.toutiao.com"
	}
	...
	accessTokenCacheKey := fmt.Sprintf("ttapp.access_token.%s", ins.GetAppid())
